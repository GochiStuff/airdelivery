    ...
    <div className="relative bg-white dark:bg-zinc-900 rounded-3xl shadow-lg p-5 sm:p-6 flex flex-col gap-5 border dark:border-zinc-800">
      ...
      <div>
        ...
        <p className="text-zinc-700 dark:text-zinc-400 text-sm sm:text-base mb-3">
          ...
          <span className="font-semibold text-blue-600 dark:text-blue-400">share it</span> or
          install.
        </p>

        <ul className="list-disc list-inside text-zinc-600 dark:text-zinc-500 text-sm space-y-2">
          <li>
            <strong className="text-zinc-800 dark:text-zinc-300">Tip:</strong> Connect both devices
            on the same network for optimal speed.
          </li>
          <li>
            <strong className="text-zinc-800 dark:text-zinc-300">Note:</strong> Avoid refreshing
            after connection is established.
          </li>
          <li>
            <strong className="text-red-500">IMP:</strong> Use Opera (suggested) or a different
            browser if site isn't working.
          </li>
        </ul>
      </div>
